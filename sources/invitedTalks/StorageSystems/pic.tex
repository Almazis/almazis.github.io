...
% \draw (0,0) rectangle (20,1);
\draw (0,3) rectangle (13.4,4);
\draw[fill=green] (0.1,3.1) rectangle (0.3,3.9);
\draw[fill=green] (0.4,3.1) rectangle (0.6,3.9);
\draw[fill=green] (0.7,3.1) rectangle (0.9,3.9);
\draw[fill=green] (1,3.1) rectangle (1.2,3.9);
\draw[fill=green] (1.3,3.1) rectangle (1.5,3.9);
\draw[fill=green] (1.6,3.1) rectangle (1.8,3.9);
\draw[fill=green] (1.9,3.1) rectangle (2.1,3.9);
\draw[fill=green] (2.2,3.1) rectangle (2.4,3.9);
\draw[fill=green] (2.5,3.1) rectangle (2.7,3.9);
\draw[fill=green] (2.8,3.1) rectangle (3,3.9);

\draw[fill=green] (3.5,3.1) rectangle (3.7,3.9);
\draw[fill=green] (3.8,3.1) rectangle (4,3.9);
\draw[fill=green] (4.1,3.1) rectangle (4.3,3.9);
\draw[fill=green](4.4,3.1) rectangle (4.6,3.9);
\draw[fill=green] (4.7,3.1) rectangle (4.9,3.9);
\draw[fill=green] (5,3.1) rectangle (5.2,3.9);
\draw[fill=green] (5.3,3.1) rectangle (5.5,3.9);
\draw[fill=green] (5.6,3.1) rectangle (5.8,3.9);
\draw[fill=green] (5.9,3.1) rectangle (6.1,3.9);
\draw[fill=green] (6.2,3.1) rectangle (6.4,3.9);

\draw[fill=green] (10.4,3.1) rectangle (10.6, 3.9);
\draw[fill=green] (10.7,3.1) rectangle (10.9, 3.9);
\draw[fill=green] (11,3.1) rectangle (11.2, 3.9);
\draw[fill=green] (11.3,3.1) rectangle (11.5, 3.9);
\draw[fill=green] (11.6,3.1) rectangle (11.8, 3.9);
\draw[fill=green] (11.9,3.1) rectangle (12.1, 3.9);
\draw[fill=green] (12.2,3.1) rectangle (12.4, 3.9);
\draw[fill=green] (12.5,3.1) rectangle (12.7, 3.9);
\draw[fill=green] (12.8,3.1) rectangle (13, 3.9);
\draw[fill=green] (13.1,3.1) rectangle (13.3, 3.9);

\draw[align=left, anchor=west] (13.6,3.5) node {Журнал};
\draw (6.65,4.2) [stealth-]-- (6.65, 5.5);
\draw[align=left, anchor=west] (6.7,5) node {Запись};
...
\draw (5, 2.5) node {Storage Node 2};
\draw (3.25, 2) rectangle (6.75, 3);

\draw (5, 3.75) node {Storage Node 1};
\draw (3.25, 3.25) rectangle (6.75, 4.25);



\draw[dashed] (6.225,1.425) ellipse (130pt and 120pt);
\node (Nw) at (6.225, -2) {Сеть};

\draw[fill=white] (1.5, 1.675) rectangle (2,3.425);
\draw[fill=white] (1.5, -0.575) rectangle (2, 1.175);
...
\draw (-0.4, 2.85) -- (1.5, 0.3);

\draw (-0.4, 1.425) -- (1.5, 2.55);
\draw (-0.4, 1.425) -- (1.5, 0.3);
